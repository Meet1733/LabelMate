  ...
  return (
    <section className="w-full py-20 relative" id="about">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            title="Login and Create Tasks"
            icon={<AceternityIcon order="Step 1"/>}
            description="Sign in to your account using your phantom wallet create data labeling tasks that need to be completed. Provide clear instructions along with images for each task to ensure accurate results."
            >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
            title="Workers Complete the Tasks" 
            icon={<AceternityIcon order="Step 2"/>}
            description="Our community of skilled workers will browse through the available tasks, select ones that match their expertise, and complete them efficiently using our intuitive platform."
            >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
            title="Earn Solana Upon Task Completion" 
            icon={<AceternityIcon order="Step 3"/>}
            description="Once the tasks are completed and approved, workers earn Solana as a reward. The earnings are securely stored in their accounts and can be accessed anytime."
            >
          <CanvasRevealEffect
            animationSpeed={3}
